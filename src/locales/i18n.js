...
const messages = {
    en: {
        global: {
            ...
            selleryEntryContent1: 'Tron The energy sharing platform aims to create an energy and bandwidth sharing platform to reduce the tariff for the majority of wave field users. Click the subscription order channel',
            selleryEntryContent2: 'Get real-time order information.',
            selleryEntryContent3: "If you hold 2 million TRX or more for a long time, you can contact the official telegram (@ tron_energysharing) to obtain the information about joining the seller's quantitative pool.",
            announcementCenter: 'Announcement Center',
            latestAnnouncement: 'Latest announcement',
            announcementCenterP1: 'Announcement on launching the first phase of million airdrop plan',
            announcementCenterP2: 'The first phase of the million airdrop plan will start at 0:00 on April 10, 2022, and end at 24:00 on April 20, 2022, Singapore time.',
            ...
            engeryAndBandWidthP1: 'Energy and bandwidth are two forms of gas fee under wave field network. If the account energy and bandwidth are insufficient, it is necessary to burn TRX to obtain energy and bandwidth. Each account obtains 1500 units of free bandwidth every day, but energy cannot be obtained free of charge. Compared with the energy and bandwidth obtained by combustion, through tron The energy sharing platform will pay rent, and the charge for energy and bandwidth will be greatly reduced.',
            basicOperation: '2. Basic operation',
            placeOrderTips: 'Place an order through the home page and select the required resource type and quantity to pay the order fee.',
            unitPrice: 'Unit Price',
            unitPriceTips: 'In case of peak traffic, the resources of Tron energy sharing platform will not meet the needs of users in real time. At this time, increasing the unit price will help users give priority to others to obtain resources.',
            security: '3.security',
            securityTips1: 'Tron energy sharing platform is currently the lowest energy sharing platform in the whole network. The platform itself has no resources to sell. The resources purchased by users come from third-party users',
            securityTips2: 'Compared with other energy trading platforms, the trading mode of Tron energy sharing platform does not adopt the way of smart contract authorization. No matter the buyer or the seller, the platform is absolutely impossible to obtain the authorization of user account transfer, which eliminates the possibility of smart contract vulnerabilities infringing on user assets. Please rest assured to use it.',
    ...
    zh: {
        global: {
            ...
            noDate: '暂无数据',
            selleryEntry: '卖家入驻',
            selleryEntryContent1: 'Tron energy-sharing平台意在打造一个能量、带宽共享平台，为广大波场用户降低资费。 点击订阅订单频道',
            selleryEntryContent2: '获取实时订单信息。',
            selleryEntryContent3: '如你长期持有200万TRX或以上数量，可联系官方电报（@Tron_energysharing），获取加入卖家量化池的信息。',
            announcementCenter: '公告中心',
            latestAnnouncement: '最新公告',
            announcementCenterP1: '关于启动第一期百万空投计划的公告',
            announcementCenterP2: '第一期百万空投计划将于新加坡时间2022年4月10日0时启动，于新加坡时间2022年4月20日24时结束。',
            announcementCenterP3: '本期空投代币信息：',
            announcementCenterP4: '名称：STAR',
            announcementCenterP5: '代币简介：stat是基于Tronchain开发的Defi属性代币，致力于创造Defi和Gamefi的一个完善的经济模型',
            ...
            engeryAndBandWidthP1: '能量和带宽是波场网络下gas费的两种形态，如账户能量和带宽不足则需燃烧TRX获得能量和带宽，每个账户每日获得的免费带宽为1500单位，能量则无法免费获得。相比较通过燃烧获得能量和带宽而言，通过Tron enery-sharing平台支付租金获得能量和带宽的资费将大大降低。',
            basicOperation: '2.基本操作',
            placeOrderTips: '通过主页下单，选择所需的资源类型、数量支付订单费用。',
            unitPrice: '单价',
            unitPriceTips: '如遇流量高峰期，Tron enery-sharing平台的资源将无法实时满足用户需求，此时提高单价则有助用户优先他人获得资源。',
            cancelOrderTips:'如遇流量高峰期，Tron enery-sharing平台的资源将无法实时满足用户需求，此时用户可选择继续等待也可选择点击“我的订单”进行撤单。',
            sellTips: '如遇流量高峰期，Tron enery-sharing平台的资源将无法实时满足用户需求，对于持有TRX的用户，可选择通过主页面“当前订单”处出售资源，赚取TRX。',
            security: '3.安全性',
            securityTips1: 'Tron enery-sharing平台目前系全网最低价的能量共享平台，平台本身没有资源可供出售。用户所购买的资源来源于第三方用户',
            securityTips2: '相比较其他能量交易平台，Tron enery-sharing平台的交易方式没有采用智能合约授权的方式，无论是买方还是卖方，平台绝无可能得到用户账户转账的授权，排除了智能合约漏洞侵害用户资产的可能，请各位用户放心使用。',
